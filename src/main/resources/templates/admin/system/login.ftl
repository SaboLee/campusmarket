...
<<<<<<< HEAD
<title>登录页面 - ${siteName!"后台管理系统"}</title>
=======
<title>登录页面 - ${siteName!""}</title>
>>>>>>> ff31f2d474b0d593574f5daa10f0f5a96ce004b1
...
<<<<<<< HEAD
        <a href=""> <img alt="light year admin" src="/admin/images/logo.png"></a>
=======
...
<<<<<<< HEAD
        <p class="m-b-0">Copyright © 2020 <a href="${siteUrl!""}">lpb</a>. All right reserved</p>
=======
